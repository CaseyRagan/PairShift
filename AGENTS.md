...
- Run `swift test`, `swift run PairShiftVerifier`, then build/test the iOS project after relevant changes. Regenerate the Xcode project with `python3 Scripts/generate_project.py` when adding Swift files.
